...
function loadEvents(){
    $.getJSON('events/event.json', function(json){
        while(typeof json["event" + event_count] != "undefined"){
            events.push(new Event());
            events[event_count].event_name = json["event" + event_count].event_name;
            events[event_count].event_image = json["event" + event_count].event_image;
            events[event_count].event_stats.push(parseInt(json["event" + event_count].event_day));
            events[event_count].event_stats.push(parseInt(json["event" + event_count].event_month));
            events[event_count].event_stats.push(parseInt(json["event" + event_count].event_year));
            events[event_count].background_colour = json["event" + event_count].background_colour;
            events[event_count].banner_colour = json["event" + event_count].banner_colour;
